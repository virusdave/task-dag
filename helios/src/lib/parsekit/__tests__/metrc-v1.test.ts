...
describe('metrc-v1 dialect: parity with legacy parseProductNameLegacy', () => {
  ...
  const cases: Array<{ parserId: string; input: string; expected: unknown }> = [
    ...
    // -- HR Botanical parity cases (one per brand-family shape) -------
    {
      parserId: 'pending-purchases.hr-botanical',
      input: 'Revert Edible Gummy Watermelon 100mg',
      expected: {
        brand: 'Revert Cannabis',
        category: 'Edibles',
        groupName: 'Watermelon Gummy',
        packCount: 1,
        prevalence: null,
        ...
        strainName: '',
        subcategory: '',
        variantName: 'Revert Cannabis Watermelon Gummy 100mg',
        variantTab: '100mg',
      },
    },
    {
      parserId: 'pending-purchases.hr-botanical',
      input: 'Revert Distillate Infused Ground Flower Pre Roll 2 Pack Blue Dream',
      expected: {
        brand: 'Revert Cannabis',
        category: 'Pre-Rolls',
        ...
        subcategory: 'Infused',
        variantName: 'Revert Cannabis Blue Dream 2x 0.5g',
        variantTab: '2x 0.5g',
      },
    },
    {
      parserId: 'pending-purchases.hr-botanical',
      input: 'Revert Pre Roll Wedding Cake .5g',
      expected: {
        brand: 'Revert Cannabis',
        category: 'Pre-Rolls',
        groupName: 'Wedding Cake',
        ...
        strainName: 'Wedding Cake',
        subcategory: '',
        variantName: 'Revert Cannabis Wedding Cake 0.5g',
        variantTab: '0.5g',
      },
    },
    {
      parserId: 'pending-purchases.hr-botanical',
      input: 'SMACK Infused 1g Pre-Roll Gelato',
      expected: {
        brand: 'Smack',
        category: 'Pre-Rolls',
        groupName: 'Gelato',
        ...
        strainName: 'Gelato',
        subcategory: 'Infused',
        variantName: 'Smack Gelato 1g',
        variantTab: '1g',
      },
    },
    {
      parserId: 'pending-purchases.hr-botanical',
      input: 'SMACK Uninfused 1g Pre-Roll Sour Diesel',
      expected: {
        brand: 'Smack',
        category: 'Pre-Rolls',
        groupName: 'Sour Diesel',
        ...
        strainName: 'Sour Diesel',
        subcategory: '',
        variantName: 'Smack Sour Diesel 1g',
        variantTab: '1g',
      },
    },
    {
      parserId: 'pending-purchases.hr-botanical',
      input: '#Juan Roll - Live Resin - Gelato',
      expected: {
        brand: '#Juan Roll',
        category: 'Pre-Rolls',
        groupName: 'Gelato',
        ...
        size: '1g',
        strainName: 'Gelato',
        // Legacy detects 'live resin' substring in input -> 'Infused'.
        // This rule hard-codes 'Infused' because Juan-Roll dash-last
        // form is almost always Live Resin in practice; non-infused
        // names surface as `regression_diff` in the reverse-shadow UI.
        subcategory: 'Infused',
        variantName: '#Juan Roll Gelato 1g',
        variantTab: '1g',
      },
    },
    {
      parserId: 'pending-purchases.hr-botanical',
      input: '#JUAN-ROLL - Live Resin - Strawberry Cough',
      expected: {
        brand: '#Juan Roll',
        category: 'Pre-Rolls',
        groupName: 'Strawberry Cough',
        packCount: 1,
        prevalence: null,
        searchTerm: 'Strawberry Cough',
        size: '1g',
        strainName: 'Strawberry Cough',
        subcategory: 'Infused',
        variantName: '#Juan Roll Strawberry Cough 1g',
        variantTab: '1g',
      },
    },
    {
      parserId: 'pending-purchases.hr-botanical',
      input: 'Ichi Roll - 1g - Pineapple Express',
      expected: {
        brand: 'Ichi Roll',
        category: 'Pre-Rolls',
        groupName: 'Pineapple Express',
        ...
        strainName: 'Pineapple Express',
        subcategory: '',
        variantName: 'Ichi Roll Pineapple Express 1g',
        variantTab: '1g',
      },
    },
    {
      parserId: 'pending-purchases.hr-botanical',
      input: 'Chopsticks 2-Pack Wedding Cake',
      expected: {
        brand: 'Chopsticks',
        category: 'Pre-Rolls',
        groupName: 'Wedding Cake',
        ...
        strainName: 'Wedding Cake',
        subcategory: '',
        variantName: 'Chopsticks Wedding Cake 2x 0.5g',
        variantTab: '2x 0.5g',
      },
    },
    {
      parserId: 'pending-purchases.hr-botanical',
      input: 'Chopstix Pre Roll 2-Pack Blue Dream',
      expected: {
        brand: 'Chopsticks',
        category: 'Pre-Rolls',
        groupName: 'Blue Dream',
        ...
        strainName: 'Blue Dream',
        subcategory: '',
        variantName: 'Chopsticks Blue Dream 2x 0.5g',
        variantTab: '2x 0.5g',
      },
    },
    {
      parserId: 'pending-purchases.hr-botanical',
      input: 'O-Yeah 5pk Pre Roll (2.5g) Gelato',
      expected: {
        brand: 'O-YEAH!',
        category: 'Pre-Rolls',
        groupName: 'Gelato',
        ...
        strainName: 'Gelato',
        subcategory: '',
        variantName: 'O-YEAH! Gelato 5x 0.5g',
        variantTab: '5x 0.5g',
      },
    },
    {
      parserId: 'pending-purchases.hr-botanical',
      input: 'State of Mind 5-Pack Pre Roll (2.5g) Wedding Cake',
      expected: {
        brand: 'State of Mind',
        category: 'Pre-Rolls',
        groupName: 'Wedding Cake',
        ...
        strainName: 'Wedding Cake',
        subcategory: '',
        variantName: 'State of Mind Wedding Cake 5x 0.5g',
        variantTab: '5x 0.5g',
      },
    },
    {
      parserId: 'pending-purchases.hr-botanical',
      input: 'STATE OF MIND 5-Pack Pre Roll (2.5g) Sour Diesel',
      expected: {
        brand: 'State of Mind',
        category: 'Pre-Rolls',
        groupName: 'Sour Diesel',
        ...
        strainName: 'Sour Diesel',
        subcategory: '',
        variantName: 'State of Mind Sour Diesel 5x 0.5g',
        variantTab: '5x 0.5g',
      },
    },
    {
      parserId: 'pending-purchases.hr-botanical',
      input: 'Sushi Hash 5pk (2.5g) Blue Dream',
      expected: {
        brand: 'Sushi Hash',
        category: 'Pre-Rolls',
        groupName: 'Blue Dream',
        ...
        strainName: 'Blue Dream',
        subcategory: '',
        variantName: 'Sushi Hash Blue Dream 5x 0.5g',
        variantTab: '5x 0.5g',
      },
    },
    {
      parserId: 'pending-purchases.hr-botanical',
      input: 'Sushi Hash Single GG4',
      expected: {
        brand: 'Sushi Hash',
        category: 'Pre-Rolls',
        groupName: 'GG4',
