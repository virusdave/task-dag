...
describe('cashier.transactions_per_hour real query', () => {
  ...
  it('attributes ratios to the correct UTC bucket and returns null in empty buckets', async () => {
    ...
    const fakePool = {
      query: vi.fn().mockResolvedValue({
        rows: [
          { bucket_start: new Date('2026-05-18T00:00:00.000Z'), value: '12.5' },
        ],
      }),
    }
    ...
    expect(data[0]).toEqual({ t: '2026-05-18T00:00:00.000Z', tx_per_hour: 12.5 })
    expect(data[1]).toEqual({ t: '2026-05-19T00:00:00.000Z', tx_per_hour: null })
  })
