...
const grouped = (atTarget = false, sample = true) => ({ data: [{ product: { id: 9, name: 'Sample', sku: null }, items: [{
...
const detail = (atTarget = false, sample = true) => ({ id: '44', currentQty: 2, availableQty: 2, externalTrackCode: 'TAG', isTradeSample: sample,
  stockLocation: atTarget ? { id: 88, name: destination.name } : { id: 12, name: 'Back Stock' }, stockType: { id: atTarget ? 7 : 3 } })
