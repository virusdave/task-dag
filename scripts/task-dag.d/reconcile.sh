...
if ! declare -F taskdag_recon_prepare >/dev/null || ! declare -F taskdag_node_complete >/dev/null \
...
# its semantics.
#
# Canonical state and aggregation live in reconciliation-core.sh. This module
# retains semantic-consumer orchestration, status rendering, and the command
# adapter. Requires activation, CAS-backoff, and reconciliation-core providers.
# ═══════════════════════════════════════════════════════════════════════
